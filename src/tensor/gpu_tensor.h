...
void gpu_tensor_fill(GPUTensor *gpu_t, float value);

// Host <-> device tranfers
GPUTensor *gpu_tensor_from_cpu(GPUTensor *cpu_t);
GPUTensor *gpu_tensor_to_cpu(GPUTensor *gpu_t);
...
void gpu_tensor_async(float *dest, float *src, void *stream);
